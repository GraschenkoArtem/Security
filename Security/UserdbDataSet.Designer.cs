...
namespace Security.UserdbDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Login], [Password], [Status]) VALUES (@Login, @Passwo" +
                "rd, @Status);\r\nSELECT Id, Login, Password, Status FROM Users WHERE (Id = SCOPE_I" +
                "DENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Users] SET [Login] = @Login, [Password] = @Password, [Status] = @St" +
                "atus WHERE (([Id] = @Original_Id));\r\nSELECT Id, Login, Password, Status FROM Use" +
                "rs WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Security.Properties.Settings.Default.UserdbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Login, Password, Status FROM dbo.Users";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserdbDataSet.UsersDataTable dataTable) {
        ...
        public virtual int Update(string Login, string Password, string Status, int Original_Id, int Id) {
            if ((Login == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Login, string Password, string Status, int Original_Id) {
            return this.Update(Login, Password, Status, Original_Id, Original_Id);
        }
    }
